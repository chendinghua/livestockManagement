package com.kymjs.app.base_res.utils.DatePicker;
...
import com.kymjs.app.base_res.utils.DatePicker.util.LinearGradient;
...
public class Baseres_WheelPicker<T> extends View {
	...
	public Baseres_WheelPicker(Context context) {
		this(context, null);
	}

	public Baseres_WheelPicker(Context context, AttributeSet attrs) {
		this(context, attrs,0);
	}

	public Baseres_WheelPicker(Context context, AttributeSet attrs, int defStyleAttr) {
	...
	private void initAttrs(Context context, AttributeSet attrs) {
		...
		TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.Baseres_WheelPicker);
		mTextSize = a.getDimensionPixelSize(R.styleable.Baseres_WheelPicker_baseres_itemTextSize,
				getResources().getDimensionPixelSize(R.dimen.baseres_ItemTextSize));
		mTextColor = a.getColor(R.styleable.Baseres_WheelPicker_baseres_itemTextColor,
				Color.BLACK);
		mIsTextGradual = a.getBoolean(R.styleable.Baseres_WheelPicker_baseres_textGradual, true);
		mIsCyclic = a.getBoolean(R.styleable.Baseres_WheelPicker_baseres_wheelCyclic, false);
		mHalfVisibleItemCount = a.getInteger(R.styleable.Baseres_WheelPicker_baseres_halfVisibleItemCount, 2);
		mItemMaximumWidthText = a.getString(R.styleable.Baseres_WheelPicker_baseres_itemMaximumWidthText);
		mSelectedItemTextColor = a.getColor(R.styleable.Baseres_WheelPicker_baseres_selectedTextColor, Color.parseColor("#33aaff"));
        mSelectedItemTextSize = a.getDimensionPixelSize(R.styleable.Baseres_WheelPicker_baseres_selectedTextSize,
                getResources().getDimensionPixelSize(R.dimen.baseres_SelectedItemTextSize));
        mCurrentPosition = a.getInteger(R.styleable.Baseres_WheelPicker_baseres_currentItemPosition, 0);
        mItemWidthSpace = a.getDimensionPixelSize(R.styleable.Baseres_WheelPicker_baseres_itemWidthSpace,
                getResources().getDimensionPixelOffset(R.dimen.baseres_ItemWidthSpace));
        mItemHeightSpace = a.getDimensionPixelSize(R.styleable.Baseres_WheelPicker_baseres_itemHeightSpace,
                getResources().getDimensionPixelOffset(R.dimen.baseres_ItemHeightSpace));
        mIsZoomInSelectedItem = a.getBoolean(R.styleable.Baseres_WheelPicker_baseres_zoomInSelectedItem, true);
        mIsShowCurtain = a.getBoolean(R.styleable.Baseres_WheelPicker_baseres_wheelCurtain, true);
        mCurtainColor = a.getColor(R.styleable.Baseres_WheelPicker_baseres_wheelCurtainColor,
		        Color.parseColor("#303d3d3d"));
        mIsShowCurtainBorder = a.getBoolean(R.styleable.Baseres_WheelPicker_baseres_wheelCurtainBorder, true);
        mCurtainBorderColor = a.getColor(R.styleable.Baseres_WheelPicker_baseres_wheelCurtainBorderColor, Color.BLACK);
        mIndicatorText = a.getString(R.styleable.Baseres_WheelPicker_baseres_indicatorText);
        mIndicatorTextColor = a.getColor(R.styleable.Baseres_WheelPicker_baseres_indicatorTextColor, mSelectedItemTextColor);
        mIndicatorTextSize = a.getDimensionPixelSize(R.styleable.Baseres_WheelPicker_baseres_indicatorTextSize, mTextSize);
		a.recycle();
	}
