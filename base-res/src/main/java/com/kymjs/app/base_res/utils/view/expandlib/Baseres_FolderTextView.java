package com.kymjs.app.base_res.utils.view.expandlib;
 ...
 * </pre>
 */
public class Baseres_FolderTextView extends AppCompatTextView {
    ...
    public Baseres_FolderTextView(Context context) {
        this(context, null);
    }

    public Baseres_FolderTextView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public Baseres_FolderTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initAttrs(context);
    }

    private void initAttrs(Context context) {
        TypedArray a = context.obtainStyledAttributes(R.styleable.Baseres_FolderTextView);
        foldLine = a.getInt(R.styleable.Baseres_FolderTextView_baseres_foldline, 3);
        a.recycle();
    }
