...
public class Baseres_DatePicker extends LinearLayout implements Baseres_YearPicker.OnYearSelectedListener,
		Baseres_MonthPicker.OnMonthSelectedListener, DayPicker.OnDaySelectedListener {

	private Baseres_YearPicker mYearPicker;
	private Baseres_MonthPicker mMonthPicker;
	 ...
	 */
	public Baseres_DatePicker(Context context) {
		this(context, null);
	}
	 ...
	 */
	public Baseres_DatePicker(Context context, AttributeSet attrs) {
	 ...
	 */
	public Baseres_DatePicker(Context context, AttributeSet attrs, int defStyleAttr) {
		super(context, attrs, defStyleAttr);
		LayoutInflater.from(context).inflate(R.layout.baseres_layout_date, this);
		initChild();
	...
	private void initAttrs(Context context, AttributeSet attrs) {
		...
		TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.Baseres_DatePicker);
		int textSize = a.getDimensionPixelSize(R.styleable.Baseres_DatePicker_baseres_itemTextSize,
				getResources().getDimensionPixelSize(R.dimen.baseres_ItemTextSize));
		int textColor = a.getColor(R.styleable.Baseres_DatePicker_baseres_itemTextColor,
				Color.BLACK);
		boolean isTextGradual = a.getBoolean(R.styleable.Baseres_DatePicker_baseres_textGradual, true);
		boolean isCyclic = a.getBoolean(R.styleable.Baseres_DatePicker_baseres_wheelCyclic, false);
		int halfVisibleItemCount = a.getInteger(R.styleable.Baseres_DatePicker_baseres_halfVisibleItemCount, 2);
		int selectedItemTextColor = a.getColor(R.styleable.Baseres_DatePicker_baseres_selectedTextColor,
				getResources().getColor(R.color.baseres_datepicker_selectedTextColor));
		int selectedItemTextSize = a.getDimensionPixelSize(R.styleable.Baseres_DatePicker_baseres_selectedTextSize,
				getResources().getDimensionPixelSize(R.dimen.baseres_SelectedItemTextSize));
		int itemWidthSpace = a.getDimensionPixelSize(R.styleable.Baseres_DatePicker_baseres_itemWidthSpace,
				getResources().getDimensionPixelOffset(R.dimen.baseres_ItemWidthSpace));
		int itemHeightSpace = a.getDimensionPixelSize(R.styleable.Baseres_DatePicker_baseres_itemHeightSpace,
				getResources().getDimensionPixelOffset(R.dimen.baseres_ItemHeightSpace));
		boolean isZoomInSelectedItem = a.getBoolean(R.styleable.Baseres_DatePicker_baseres_zoomInSelectedItem, true);
		boolean isShowCurtain = a.getBoolean(R.styleable.Baseres_DatePicker_baseres_wheelCurtain, true);
		int curtainColor = a.getColor(R.styleable.Baseres_DatePicker_baseres_wheelCurtainColor, Color.WHITE);
		boolean isShowCurtainBorder = a.getBoolean(R.styleable.Baseres_DatePicker_baseres_wheelCurtainBorder, true);
		int curtainBorderColor = a.getColor(R.styleable.Baseres_DatePicker_baseres_wheelCurtainBorderColor,
				getResources().getColor(R.color.baseres_datepicker_divider));
		a.recycle();
	 ...
	 */
	public Baseres_YearPicker getYearPicker() {
		return mYearPicker;
	}
	 ...
	 */
	public Baseres_MonthPicker getMonthPicker() {
		return mMonthPicker;
	}
