package com.kymjs.app.base_res.utils.dialog.stockDialog;
...
public class StockDialog extends Dialog {
    ...
    public StockDialog(@NonNull Context context) {
        super(context);
    ...
    public static class Builder {
        ...
        public Builder(Context context) {
            ...
            dialog = new StockDialog(context, R.style.baseres_Dialog);
         ...
         * @return
         */
        public StockDialog createSingleButtonDialog() {
            showSingleButton();
         ...
         * @return
         */
        public StockDialog createTwoButtonDialog() {
