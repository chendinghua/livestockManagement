package com.kymjs.app.base_res.utils.DatePicker.time;
 ...
 */
public class Baseres_HourAndMinutePicker extends LinearLayout implements
    ...
    public Baseres_HourAndMinutePicker(Context context) {
        this(context, null);
    }

    public Baseres_HourAndMinutePicker(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public Baseres_HourAndMinutePicker(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        LayoutInflater.from(context).inflate(R.layout.baseres_layout_time, this);
        initChild();
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.Baseres_HourAndMinutePicker);
        int textSize = a.getDimensionPixelSize(R.styleable.Baseres_HourAndMinutePicker_baseres_itemTextSize,
                getResources().getDimensionPixelSize(R.dimen.baseres_ItemTextSize));
        int textColor = a.getColor(R.styleable.Baseres_HourAndMinutePicker_baseres_itemTextColor,
                Color.BLACK);
        boolean isTextGradual = a.getBoolean(R.styleable.Baseres_HourAndMinutePicker_baseres_textGradual, true);
        boolean isCyclic = a.getBoolean(R.styleable.Baseres_HourAndMinutePicker_baseres_wheelCyclic, true);
        int halfVisibleItemCount = a.getInteger(R.styleable.Baseres_HourAndMinutePicker_baseres_halfVisibleItemCount, 2);
        int selectedItemTextColor = a.getColor(R.styleable.Baseres_HourAndMinutePicker_baseres_selectedTextColor,
                getResources().getColor(R.color.baseres_datepicker_selectedTextColor));
        int selectedItemTextSize = a.getDimensionPixelSize(R.styleable.Baseres_HourAndMinutePicker_baseres_selectedTextSize,
                getResources().getDimensionPixelSize(R.dimen.baseres_SelectedItemTextSize));
        int itemWidthSpace = a.getDimensionPixelSize(R.styleable.Baseres_HourAndMinutePicker_baseres_itemWidthSpace,
                getResources().getDimensionPixelOffset(R.dimen.baseres_ItemWidthSpace));
        int itemHeightSpace = a.getDimensionPixelSize(R.styleable.Baseres_HourAndMinutePicker_baseres_itemHeightSpace,
                getResources().getDimensionPixelOffset(R.dimen.baseres_ItemHeightSpace));
        boolean isZoomInSelectedItem = a.getBoolean(R.styleable.Baseres_HourAndMinutePicker_baseres_zoomInSelectedItem, true);
        boolean isShowCurtain = a.getBoolean(R.styleable.Baseres_HourAndMinutePicker_baseres_wheelCurtain, true);
        int curtainColor = a.getColor(R.styleable.Baseres_HourAndMinutePicker_baseres_wheelCurtainColor, Color.WHITE);
        boolean isShowCurtainBorder = a.getBoolean(R.styleable.Baseres_HourAndMinutePicker_baseres_wheelCurtainBorder, true);
        int curtainBorderColor = a.getColor(R.styleable.Baseres_HourAndMinutePicker_baseres_wheelCurtainBorderColor,
