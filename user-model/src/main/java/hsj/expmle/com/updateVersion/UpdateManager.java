package hsj.expmle.com.updateVersion;
...
public class UpdateManager
{
	...
	private void showNoticeDialog()
	{
		...
		builder.setTitle(R.string.user_model_soft_update_title);
		builder.setMessage(R.string.user_model_soft_update_info);
		// 更新
		builder.setPositiveButton(R.string.user_model_soft_update_updatebtn, new OnClickListener()
		{
			@Override
		...
		// 稍后更新
		builder.setNegativeButton(R.string.user_model_soft_update_later, new OnClickListener()
		{
			@Override
			public void onClick(DialogInterface dialog, int which)
			{
	...
	private void showDownloadDialog()
	{
		...
		Builder builder = new Builder(mContext);
        builder.setCancelable(false);
		builder.setTitle(R.string.user_model_soft_updating);
		// 给下载对话框增加进度条
		final LayoutInflater inflater = LayoutInflater.from(mContext);
		View v = inflater.inflate(R.layout.user_model_softupdate_progress, null);
		mProgress = (ProgressBar) v.findViewById(R.id.update_progress);
		builder.setView(v);
		// 取消更新
		builder.setNegativeButton(R.string.user_model_soft_update_cancel, new OnClickListener()
		{
			@Override
			public void onClick(DialogInterface dialog, int which)
			{
