package hsj.expmle.com.platformwms.ui.activity;
...
import hsj.expmle.com.platformwms.tools.HandlerUtils;
import hsj.expmle.com.platformwms.tools.HandlerUtilsCallback;
import hsj.expmle.com.platformwms.tools.InteractiveDataUtil;
import hsj.expmle.com.platformwms.tools.InteractiveEnum;
import hsj.expmle.com.platformwms.tools.MethodEnum;
import hsj.expmle.com.platformwms.tools.UIHelper;
import hsj.expmle.com.platformwms.ui.entry.DicInfo;
...
public class PdaParamSettingActivity extends Activity implements View.OnClickListener{
    ...
    private void initUI() {
        ...
        save=findViewById(R.id.btn_pda_param_save);
