...
public class WheelOptions<T> {
    ...
    public void setPicker(List<T> options1Items,
        ...
        if (mOptions3Items != null) {
            Log.d("itemSize", "setPicker:   mOptions3Items.get().size()"+mOptions1Items.size()+


                    "    mOptions3Items.get().get().size "+mOptions3Items.get(0).size());
                ...
                try {
                    ...
                    if (mOptions3Items != null) {
                        ...
                        if (!isRestoreItem) {
                            ...
                            opt3 = wv_option3.getCurrentItem() >=
                                    mOptions3Items.get(opt1Select).get(index).size() - 1 ?
                                    mOptions3Items.get(opt1Select).get(index).size() - 1 :
                    ...
                    Log.d("selectItemError", "onItemSelected: "+e.getMessage());
                    e.printStackTrace();
                }
            }
        };
